        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "❰𝗦𝘂𝗽𝗽𝗼𝗿𝘁🌎❱", url="https://t.me/india_chat_002"
                    ),
                    InlineKeyboardButton(
                        "❰𝗚𝗿𝗼𝘂𝗽🚩❱", url="https://t.me/india_chat_002"
                    )
                ],[ 
                    InlineKeyboardButton(
...
async def gstart(_, message: Message):
      await message.reply_text("""**𝗔𝗺𝗮𝗻𝘃𝐌𝐮𝐬𝐢𝐜 𝐎𝐧𝐥𝐢𝐧𝐞\n🌠𝗶𝗻𝗱𝗶𝗮𝗰𝗵𝗮𝘁_02_𝐎𝐩 🥀**""",
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "𝗦𝘂𝗽𝗽𝗼𝗿𝘁❤️", url="https://t.me/india_chat_002")
                ]
            ]
        )
   )
